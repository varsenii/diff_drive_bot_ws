...
def generate_launch_description():
    ...
    world_file_name = LaunchConfiguration(
        ...
        default=PathJoinSubstitution(
            [FindPackageShare("robot"), "worlds", "obstacles.world"]
        ),
    )
    map_file_name = LaunchConfiguration(
        "map",
        default=PathJoinSubstitution(
            [FindPackageShare("robot"), "config", "course_map.yaml"]
        ),
    )
    ...
    localization_launch = IncludeLaunchDescription(
        ...
        launch_arguments={"map": map_file_name, "use_sim_time": use_sim_time}.items(),
    )
    ...
    return LaunchDescription(
        [debug_log, diff_drive_bot_launch, localization_launch, navigation_launch]
    )
